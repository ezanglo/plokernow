  ...
  <q-layout view="hHh Lpr lFf">
    <q-header elevated class="bg-indigo">
      <q-toolbar>
        ...
        <q-btn flat dense icon-right="settings" label="Settings">
          <q-menu>
            <q-item clickable @click="updateCurrentPlayerName">
            ...
            <q-item clickable>
              ...
              <q-item-section>Share Game</q-item-section>
            </q-item>
            <q-item clickable>
              <q-item-section avatar>
                <q-icon color="primary" name="settings" />
              </q-item-section>
              <q-item-section>Game Settings</q-item-section>
            </q-item>
          </q-menu>
        </q-btn>
      </q-toolbar>
